...
export const metadata = {
  ...
  description: `Terms of Service governing the use of ${siteConfig.name} website and purchase of products.`,
};
...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      subtitle={`Welcome to ${siteConfig.name}. By accessing our website at ${siteConfig.url.replace(/^https?:\/\//, "")} or purchasing products from us, you agree to be bound by these Terms of Service.`}
      sections={[
        {
        ...
        },
        {
          title: "2. Eligibility",
          content: [
            `Access to ${siteConfig.name} products and services is limited to qualified researchers, laboratory professionals, and organizations engaged in legitimate scientific research. ${siteConfig.name} reserves the right to approve or deny any customer or order at its sole discretion. We may request verification of research credentials or institutional affiliation at any time. Failure to provide satisfactory verification may result in order cancellation or account termination.`,
          ],
        },
        {
          title: "3. Products and Intended Use",
          content: [
            `All products sold by ${siteConfig.name} are intended for laboratory research purposes only. None of our products or statements have been evaluated by the Food and Drug Administration (FDA). By purchasing from us, you acknowledge and agree that:`,
            [
        ...
        },
        {
          ...
          content: [
            `All content on the Website, including text, graphics, logos, images, and software, is the property of ${siteConfig.name} or its licensors and is protected by intellectual property laws. You may not reproduce, distribute, modify, or create derivative works without our express written permission.`,
          ],
        },
        {
          ...
          content: [
            ...
            [
              ...
              `Discuss, promote, or engage in any practice of human or animal dosing of products purchased from ${siteConfig.name}`,
              `Market, label, or represent any product purchased from ${siteConfig.name} as suitable for human consumption, therapeutic use, or veterinary application`,
            ],
            `Violation of any of the above prohibited conduct — in particular any discussion or practice of human or animal dosing — may result in immediate termination of your account, cancellation of pending orders, and a permanent ban from ${siteConfig.name} services, at our sole discretion.`,
          ],
        },
        {
          title: "9. Termination",
          content: [
            `${siteConfig.name} reserves the right to suspend or terminate your account and refuse any current or future use of the Website at any time, for any reason, at our sole discretion. This includes, without limitation, termination for violation of these Terms, suspected misuse of products, failure to provide satisfactory research credentials upon request, or any conduct that we determine to be harmful to our business, other customers, or the integrity of our operations. Termination of your account does not relieve you of any obligations under these Terms, including indemnification.`,
          ],
        },
        {
          title: "10. Assumption of Risk",
          content: [
            `YOU EXPRESSLY ACKNOWLEDGE AND AGREE THAT YOUR PURCHASE, POSSESSION, HANDLING, STORAGE, AND USE OF ANY PRODUCTS FROM ${siteConfig.name.toUpperCase()} IS AT YOUR SOLE AND EXCLUSIVE RISK. ${siteConfig.name.toUpperCase()} SELLS RESEARCH CHEMICALS INTENDED SOLELY FOR IN-VITRO LABORATORY USE. BY PURCHASING ANY PRODUCT, YOU VOLUNTARILY ASSUME ALL RISKS ASSOCIATED WITH THE PRODUCT, INCLUDING BUT NOT LIMITED TO RISKS ARISING FROM IMPROPER STORAGE, HANDLING, CONTAMINATION, DEGRADATION, MISUSE, OR ANY APPLICATION OF THE PRODUCT TO ANY HUMAN OR ANIMAL. YOU WAIVE ANY AND ALL CLAIMS AGAINST ${siteConfig.name.toUpperCase()} ARISING FROM YOUR USE OR MISUSE OF PRODUCTS TO THE FULLEST EXTENT PERMITTED BY LAW.`,
          ],
        },
        {
          title: "11. Disclaimer of Warranties",
          content: [
            `THE WEBSITE AND ALL PRODUCTS ARE PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED. TO THE FULLEST EXTENT PERMITTED BY LAW, ${siteConfig.name.toUpperCase()} DISCLAIMS ALL WARRANTIES, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT, AND ANY WARRANTIES ARISING FROM COURSE OF DEALING OR USAGE OF TRADE.`,
          ],
        },
        {
          title: "12. Limitation of Liability",
          content: [
            `TO THE MAXIMUM EXTENT PERMITTED BY LAW, ${siteConfig.name.toUpperCase()} AND ITS OWNERS, OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, AND AFFILIATES SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES ARISING FROM OR RELATED TO YOUR USE OF THE WEBSITE, PURCHASE OF PRODUCTS, OR ANY ACTIONS TAKEN BASED ON INFORMATION PROVIDED ON THE WEBSITE. OUR TOTAL AGGREGATE LIABILITY FOR ALL CLAIMS ARISING UNDER OR RELATED TO THESE TERMS SHALL NOT EXCEED THE AMOUNT YOU PAID TO ${siteConfig.name.toUpperCase()} FOR THE SPECIFIC PRODUCT(S) GIVING RISE TO THE CLAIM.`,
          ],
        },
        {
          title: "13. Indemnification",
          content: [
            `You agree to indemnify, defend, and hold harmless ${siteConfig.name}, its owners, officers, directors, employees, agents, and affiliates from and against any and all claims, demands, actions, suits, proceedings, damages, losses, liabilities, judgments, settlements, fines, penalties, costs, and expenses (including reasonable attorneys' fees) arising out of or related to:`,
            [
              `Your use, misuse, or handling of any products purchased from ${siteConfig.name}`,
              `Any statements, claims, representations, or advice you make or provide to any third party regarding ${siteConfig.name} products`,
              `Any advertising, marketing, social media content, reviews, testimonials, or promotional materials you create referencing ${siteConfig.name} products`,
              ...
              `Any regulatory action, investigation, or enforcement proceeding brought against ${siteConfig.name} as a result of your actions`,
            ],
        ...
        },
        {
          ...
          content: [
            ...
            `YOU AGREE THAT ANY DISPUTE RESOLUTION PROCEEDINGS WILL BE CONDUCTED ONLY ON AN INDIVIDUAL BASIS AND NOT IN A CLASS, CONSOLIDATED, OR REPRESENTATIVE ACTION. YOU WAIVE ANY RIGHT TO PARTICIPATE IN A CLASS ACTION LAWSUIT OR CLASS-WIDE ARBITRATION AGAINST ${siteConfig.name.toUpperCase()}.`,
        ...
        },
        {
          title: "18. Waiver",
          content: [
            `The failure of ${siteConfig.name} to enforce any right or provision of these Terms shall not constitute a waiver of such right or provision. Any waiver of any provision of these Terms will be effective only if in writing and signed by ${siteConfig.name}.`,
          ],
        },
        {
          title: "19. Entire Agreement",
          content: [
            `These Terms, together with our Privacy Policy, Disclaimer, and any other policies referenced herein, constitute the entire agreement between you and ${siteConfig.name} regarding your use of the Website and purchase of products. These Terms supersede all prior or contemporaneous communications, representations, or agreements, whether oral or written.`,
          ],
        },
      ]}
    />
