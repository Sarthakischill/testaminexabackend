...
import { Mail, MapPin, Clock, Send, CheckCircle, ArrowLeft } from "lucide-react";
    ...
    <main className="relative min-h-screen w-full bg-[#050505] selection:bg-white/20 selection:text-white">
      ...
      <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-xl bg-[#050505]/80 border-b border-white/5">
        <div className="w-full px-4 sm:px-6 md:px-10 lg:px-14 xl:px-20 h-16 flex items-center justify-between">
          ...
          <Link href="/" className="group flex items-center gap-2 text-white/40 hover:text-white transition-colors">
            ...
            <span style={{ fontFamily: "Helvetica, Arial, sans-serif" }} className="text-xs font-medium tracking-[0.1em] uppercase hidden sm:inline">
              Back to Site
            </span>
          </Link>
        </div>
      ...
      <div className="relative w-full pt-40 pb-16 md:pt-48 md:pb-24 px-4 sm:px-6 md:px-10 lg:px-14 xl:px-20">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          >
            Questions about our research compounds, orders, or wholesale inquiries? We&apos;re here to help.
          </motion.p>
        </div>
      </div>
          ...
          >
            {submitted ? (
              <div className="p-12 md:p-16 rounded-2xl bg-white/[0.02] border border-white/10 text-center flex flex-col items-center">
                ...
                <h2 style={{ fontFamily: "Helvetica, Arial, sans-serif" }} className="text-2xl md:text-3xl font-normal text-white mb-3">
                  Message Sent
                </h2>
